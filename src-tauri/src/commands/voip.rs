...
pub async fn join_voice_channel(
    ...
    // The .well-known is typically at the server_name domain (from user ID, e.g. "hoomestead.com")
    // but could also be at the homeserver URL domain (e.g. "matrix.hoomestead.com").
