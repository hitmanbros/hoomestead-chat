 ...
 * Strips device ID suffix from LiveKit identities: @user:example.com:DeviceId -> @user:example.com
 */
...
/** Extract readable display name from a Matrix user ID like @user:example.com or @user:example.com:DeviceId */
